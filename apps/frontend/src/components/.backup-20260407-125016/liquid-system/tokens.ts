...
const toneShells: Record<GlassTone, { base: string; cheap: string }> = {
  neutral: {
    base: 'text-slate-900 dark:text-white',
    cheap: 'bg-white/55 border-white/35 dark:bg-slate-950/42 dark:border-white/10',
  },
  brand: {
    base: 'text-blue-700 dark:text-blue-100',
    cheap: 'bg-blue-500/15 border-blue-300/35 dark:bg-blue-500/14 dark:border-blue-300/20',
  },
  inverse: {
    base: 'text-white',
    cheap: 'bg-slate-950/60 border-white/12 dark:bg-black/58 dark:border-white/14',
  },
}
